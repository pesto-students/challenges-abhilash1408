...
describe('sumFibsMemoized', () => {
  ...
  it('should run sumFib and cache results',()=>{
    const myCachedFunction = cacheFunction(sumFibs);
    expect(myCachedFunction(1000)).toBe(1785);
    myCachedFunction(1000);
    myCachedFunction(1000);
    expect(myCachedFunction(15000)).toBe(14328);
    myCachedFunction(15000);
    myCachedFunction(15000);
    myCachedFunction(15000);
    expect(myCachedFunction(500000)).toBe(574925);
    myCachedFunction(500000);
  })
});
